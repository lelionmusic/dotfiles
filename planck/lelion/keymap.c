...
[_QWERTY] = {
  ...
  {KC_CAPS, MO(_NAV),        _______, KC_LALT, KC_LGUI, KC_SPC, KC_SPC,  RAISE,    LOWER, MO(_NAV), KC_UP,   KC_RGHT}},
...
[_LOWER] = {
    {KC_TILD, _______, _______, _______, _______, _______, _______, UNICODE, UC(0x00E6), UC(0x00F8), UC(0x00E5), _______},
    {_______, _______, _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,   _______,    KC_PIPE},
